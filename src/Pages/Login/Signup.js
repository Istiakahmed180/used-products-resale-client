...
const Signup = () => {
  return (
    <div>
      <div class="my-10 flex w-full max-w-sm mx-auto overflow-hidden bg-white rounded-lg shadow-lg dark:bg-gray-800 lg:max-w-4xl">
        <div class="hidden lg:block lg:w-[80%] mt-7">
          <img
            src="https://carta.v-card.es/assets/images/user/login.png"
            alt=""
            className=""
          />
        </div>
